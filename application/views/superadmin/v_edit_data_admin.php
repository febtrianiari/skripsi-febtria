          ...
          <div class="col-12">
            <div class="card card-chart">
              ...
              <?php
                        ...
                        ?>
              <!-- CONTENTT -->
              <form action="<?php echo base_url('superadmin/c_data_admin/update_admin')?>?id_login=<?php echo $login['id_login']?>" method="post">
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Nama Admin</label>
                        <input type="text" class="form-control" name="nama" value="<?php echo $login['nama']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="telepon" value="<?php echo $login['telepon']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="password" value="<?php echo $login['password']?>">
                      </div>
                    </div>
                    </div>
                  </div>

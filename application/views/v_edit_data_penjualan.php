          ...
          <div class="col-12">
            <div class="card card-chart">
              ...
              <?php
                ...
                {
              ?>
              <form action="<?php echo base_url('admin/c_penjualan/update_penjualan')?>?id_penjualan=<?php echo $data_penjualan['id_penjualan']?>" method="post">
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Nama Kategori</label>
                        <select class="form-control" name="list_id_kategori">
                        <option value ="<?php echo $data_penjualan['id_kategori']?> "><?php echo $data_penjualan['nama_kategori']?></option>
                          <?php
                          foreach($kategori as $kategori)
                          {
                            if($kategori['id_kategori'] != $data_penjualan['id_kategori']){
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Tahun</label>
                        <input type="text" class="form-control" name="tahun" value="<?php echo $data_penjualan['tahun']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jumlah_penjualan" value="<?php echo $data_penjualan['jumlah_penjualan']?>">
                      </div>
                    </div>
                    </div>
                  </div>
